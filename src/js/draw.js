...
import moonSurface from '../img/lroc_color_poles_2k.png';
import heightMap from '../img/ldem_4.png';
...
const texture = new THREE.TextureLoader().load(moonSurface);
const heightTexture = new THREE.TextureLoader().load(heightMap);
...
// 赤道
const torusGeometry = new THREE.TorusGeometry(3.02, 0.02, 16, 100);
